...
class FeatureVisualization:
    ...
    def analyze_relevance(self, rel, layer_name, concept, data_indices, targets):
        ...
        d_c_sorted, rel_c_sorted, rf_c_sorted, argsort = self.RelMax.analyze_layer(rel, concept, layer_name,
                                                                                   data_indices)
    ...
    def analyze_activation(self, act, layer_name, concept, data_indices, targets):
        ...
        d_c_sorted, act_c_sorted, rf_c_sorted, argsort = self.ActMax.analyze_layer(act, concept, layer_name,
                                                                                   data_indices)
